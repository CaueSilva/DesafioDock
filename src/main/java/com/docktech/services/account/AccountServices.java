...
public class AccountServices {
	...
	public Account createAccount(Account account) {
		...
		Client client = clientServices.findById(account.getClientId());
	...
	public Account changeAccountStatus(Account account) {
		...
		securityServices.checkIfIsTheSameCustomer(clientServices.findById(account.getClientId()).getCpf());
	...
	public List<AccountMovement> extractAccount(ExtractInformation extractInformation) {
		...
		securityServices.checkIfIsTheSameCustomer(clientServices.findById(extractInformation.getClientId()).getCpf());
	...
	public AccountMovement deposit(AccountMovement movement) {
		...
		securityServices.checkIfIsTheSameCustomer(clientServices.findById(movement.getClientId()).getCpf());
